...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { description: @education.description, period_begin: @education.period_begin, period_end: @education.period_end, title: @education.title } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { description: @education.description, period_begin: @education.period_begin, period_end: @education.period_end, title: @education.title } }
